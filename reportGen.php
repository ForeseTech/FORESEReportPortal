...
$content="";
$reg=$_POST['numberInput'];


try{
    $conn=setConn();

	$sql_stmt="SELECT* FROM SCORES WHERE REG_NO='$reg';";
	...
	foreach($results as $row){
		...
		$content.="
				...
				<br>
				<ul>
					<li>Scores of the candidate are shown per section. Each section is marked out of 5. The total score is out of 25.</li>
